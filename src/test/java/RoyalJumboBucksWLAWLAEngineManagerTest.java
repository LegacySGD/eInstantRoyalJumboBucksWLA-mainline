...
public class RoyalJumboBucksWLAWLAEngineManagerTest
{
	...
	{
		logger = Logger.getLogger(RoyalJumboBucksWLAWLAEngineManagerTest.class);
		gameParams = XMLUtil.parseResource("paymodel/RoyalJumboBucksWLAIW/GameParams.xml").getDocumentElement();
		previousOutcome = XMLUtil.parseResource("paymodel/RoyalJumboBucksWLAIW/InitOutcome.xml").getDocumentElement();
